...
//        $gv_order_amount += 0.001;
  ...
  $selection_string2 .= '<td class="main">' . "\n";
        $selection_string2 .= TEXT_ENTER_GV_CODE . tep_draw_input_field('gv_redeem_code1') . ' and click ';
  ...
  $selection_string2 .= '</tr>' . "\n";
      /*  $selection_string .= '<tr><td ><table width="100%"></tr>' . "\n";
        ...
        $selection_string .= '</tr></table></td></tr>' . "\n";*/
      }
    ...
    function collect_posts() {
      ...
      if ($HTTP_POST_VARS['gv_redeem_code1']) {
        $gv_query = tep_db_query("select coupon_id, coupon_type, coupon_amount from " . TABLE_COUPONS . " where coupon_code = '" . $HTTP_POST_VARS['gv_redeem_code1'] . "'");
        $gv_result = tep_db_fetch_array($gv_query);
