...
// catalog payment module class methods
    ...
    function formFields($txn_sign = '', $payment_amount = '', $payment_currency = '', $payment_currency_value = '', $orders_id = '', $return_url = '', $cancel_url = '' ) {
      ...
      $return_href_link = tep_not_null($return_url) ? $return_url : tep_href_link(FILENAME_CHECKOUT_SUCCESS, 'action=success&order_status='.MODULE_PAYMENT_PAYPAL_ORDER_STATUS_ID.'&oID=' .((tep_not_null($orders_id)) ? $orders_id : $this->orders_id), 'SSL');//FILENAME_CHECKOUT_SUCCESS
