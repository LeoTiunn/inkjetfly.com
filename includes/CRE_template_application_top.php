...
//set mainpage modules directory
...
$modules_folder = DIR_WS_MODULES . '/mainpage_modules/';
  ...
  define('DIR_WS_TEMPLATE_MODULES', $modules_folder);
  ...
  // define content module location
    $additional_module_folder = DIR_WS_MODULES ;
   define('TEMPLATE_ADDITIONAL_MODULES_FOLDER', $additional_module_folder);

   define('DIR_FS_TEMPLATE_BOXES', DIR_WS_TEMPLATES . TEMPLATE_NAME . '/boxes');

  if( file_exists(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/boxes.tpl.php')){
