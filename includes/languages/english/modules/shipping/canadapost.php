...
define('MODULE_SHIPPING_CANADAPOST_ERROR_1', 'An unknown error occured with the canadapost shipping calculations.');
define('MODULE_SHIPPING_CANADAPOST_ERROR_2', '<br>If you prefer to use canadapost as your shipping method, please contact the store owner.');
