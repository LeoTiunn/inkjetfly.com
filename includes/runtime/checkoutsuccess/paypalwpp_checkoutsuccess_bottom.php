<?php
/*
  $Id: paypalwpp_checkoutsuccess_bottom.php,v 1.0.0.0 2007/11/13 13:41:11 datazen Exp $
...
if (defined('MODULE_PAYMENT_PAYPAL_WPP_STATUS') && MODULE_PAYMENT_PAYPAL_WPP_STATUS == 'True') {
  ...
  if (isset($_SESSION['paypalwpp_create_account'])) unset($_SESSION['paypalwpp_create_account']);
