...
function categoriesBoxContents($contents) {
  ...
  class infoBoxHeading extends tableBox {
    function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents[] = array(array('params' => 'height="14"',
                                         'text' => $left_corner),
                                   array('params' => 'valign="top" align="center" background="' . DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/infobox/background.gif" width="100%"  class="infoBoxHeading"', 'text' => $contents[0]['text']),
  ...
  class infoboxFooter extends tableBox {
    function infoBoxFooter($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents[] = array(array('params' =>  'class="infoBoxfooter"','text' => $left_corner),
                                   array('params' => 'background="' . DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/infobox/infobox_footer_middle.gif" width="100%" ', 'text' => $contents[0]['text']),
  ...
  class contentBoxHeading extends tableBox {
    function contentBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents[] = array(array('params' => 'height="14"',
                                         'text' => $left_corner),
                                   array('params' => 'valign="top" align="center" background="' . DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/infobox/background.gif" width="100%"  class="contentBoxHeading"', 'text' => $contents[0]['text']),
                                   array('params' => 'height="14" nowrap',
                                         'text' => $right_corner));
