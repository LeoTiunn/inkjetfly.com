...
<?php
 ...
 ?>
  <tr>
    ...
    <td align="right" valign="middle" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FEATURED_PRODUCTS, tep_get_all_get_params(array('action','cPath','products_id')) . 'action=buy_now&products_id=' . $featured_products_array[$i]['id'] . '&cPath=' . tep_get_product_path($featured_products_array[$i]['id']), 'NONSSL') . '">' . tep_template_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART) . '</a>'; ?></td>
  </tr>
<?php
