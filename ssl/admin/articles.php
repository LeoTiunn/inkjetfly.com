...
?>
          ...
          <tr>
            <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main"><?php echo tep_draw_textarea_field('topics_description[' . $languages[$i]['id'] . ']', 'soft', '70', '20', (isset($topics_description[$languages[$i]['id']]) ? stripslashes($topics_description[$languages[$i]['id']]) : tep_get_topic_description((isset($tInfo->topics_id) ? $tInfo->topics_id : 0), $languages[$i]['id'])),' style="width: 100%" mce_editable="true"'); ?></td>
              </tr>
            </table></td>
          </tr>
