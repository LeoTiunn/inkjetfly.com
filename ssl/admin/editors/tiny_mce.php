...
function tep_insert_html_editor ( $textarea, $tool_bar_set = HTML_EDITOR_TOOLBAR_SET, $editor_height = HTML_EDITOR_TINYMCE_HEIGHT ) {
 global $request_type, $extended_valid_elements;
    ...
    echo 'document_base_url : "' . tep_catalog_href_link() . '",' . "\n"; 
 ...
 switch ($tool_bar_set) {
    ...
    echo 'theme_advanced_source_editor_height : "' . (defined('HTML_EDITOR_TINYMCE_HEIGHT') ? HTML_EDITOR_TINYMCE_HEIGHT : '400') . '",' . "\n";
    echo 'theme_advanced_source_editor_width : "' . (defined('HTML_EDITOR_TINYMCE_WIDTH') ? HTML_EDITOR_TINYMCE_WIDTH : '600') . '",' . "\n";
