...
$PHPTHUMB_CONFIG['document_root'] = DIR_FS_CATALOG;  // custom mod to support CRE Loaded
...
$PHPTHUMB_CONFIG['cache_source_directory'] = DIR_FS_CATALOG.'cache/phpthumb/source/';  // set the cache directory for unprocessed source images
