  ...
  while ($order = tep_db_fetch_array($order_query)) {
    ...
    switch ($method) {
      ...
      case '2':
        ...
        break;
      case '3':
        $cc_number = substr($order['cc_number'], 0, 4) . 'XXXXXXXX' . substr($order['cc_number'], -6);
        break;                
    }   
      ...
      if ($action == 'process') {
        ...
        <tr><?php echo tep_draw_form('purge', 'cc_purge.php', 'action=process', 'post'); ?>
          <td width="100%" valign="top"><table border="0" width="60%" cellspacing="0" cellpadding="2">
            ...
            echo '<tr><td class="main">' . tep_draw_radio_field('method', '3') . ' Mask First 4 and Last 6 of Credit Card Info (XXXX123456XXXXXX)</td></tr>';         
            ?>
            <tr><td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td></tr>
            <tr>
