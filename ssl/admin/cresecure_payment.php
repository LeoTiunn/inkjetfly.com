...
if ($response_code == '000') {  // success
  ...
  tep_db_query("update " . TABLE_ORDERS . " set orders_status = '" . (MODULE_PAYMENT_CRESECURE_ORDER_STATUS_COMPLETE_ID > 0 ? (int)MODULE_PAYMENT_CRESECURE_ORDER_STATUS_COMPLETE_ID : (int)DEFAULT_ORDERS_STATUS_ID) . "', last_modified = now() where orders_id = '" . $response_orderID . "'");
