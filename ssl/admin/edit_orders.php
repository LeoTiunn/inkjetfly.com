...
if (isset($_POST['update_products'])) {
  $_POST['update_products'] = (str_replace("\\",'',$_POST['update_products']));
}
if (isset($_POST['update_totals'])) {
  $_POST['update_totals'] = (str_replace("\\",'',$_POST['update_totals'])); 
}
...
//check for qty pricing.
  if ($products_details['qty'] >= 1){
    ...
    $special_price = tep_get_products_special_price($orders_products_id);
...
// intialize for first attribute
  ...
  $customer_id = $order->customer['id'];
    ...
    ");
     ...
     $special_price = tep_get_products_special_price($add_product_products_id);
...
<!-- Begin Addresses Block -->
      <tr>
       ...
       /* if (isset($_SESSION['is_std']) && $_SESSION['is_std'] === true) {
          ...
          echo tep_draw_form('edit_order', FILENAME_EDIT_ORDERS,'action=update_order&oID=' . $oID, 'post', '', 'SSL'); 
    //    }
        ?>
