            ...
            <tr>
              ...
              <td class="main">
                ...
                if ($processed == true) {
                  ...
                  if($cInfo->customers_selected_template == '') {
                    echo tep_draw_pull_down_menu('customers_selected_template', $existing_templates_array, DEFAULT_TEMPLATE);
                  } else {
              ...
              <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="data-table">
                <tr class="dataTableHeadingRow">
                  ...
                  <td class="dataTableHeadingContent" valign="top">
                    ...
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=company'); ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . ENTRY_COMPANY . ALT_IC_UP); ?></a>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=company-desc'); ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . ENTRY_COMPANY . ALT_IC_DOWN); ?></a>
                  </td>
                  <td class="dataTableHeadingContent" valign="top">
                    <?php echo TABLE_HEADING_LASTNAME; ?>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=lastname'); ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_LASTNAME . ALT_IC_UP); ?></a>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=lastname-desc'); ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_LASTNAME . ALT_IC_DOWN); ?></a>
                  </td>
                  <td class="dataTableHeadingContent" valign="top">
                    <?php echo TABLE_HEADING_FIRSTNAME; ?>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=firstname'); ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_FIRSTNAME . ALT_IC_UP); ?></a>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=firstname-desc'); ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_FIRSTNAME . ALT_IC_DOWN); ?></a>
                  </td>
                  <td class="dataTableHeadingContent" align="right" valign="top">
                    <?php echo TABLE_HEADING_ACCOUNT_CREATED; ?>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=id-asc'); ?>"><?php echo tep_icon_submit('ic_up.gif', ' Sort ' . TABLE_HEADING_ACCOUNT_CREATED . ALT_IC_UP_NUM); ?></a>
                    <a href="<?php echo tep_href_link(FILENAME_CUSTOMERS,'listing=id-desc'); ?>"><?php echo tep_icon_submit('ic_down.gif', ' Sort ' . TABLE_HEADING_ACCOUNT_CREATED . ALT_IC_DOWN_NUM); ?></a>
                  </td>
                ...
                $customers_query_raw = "select c.customers_id, c.customers_lastname, c.customers_firstname, c.customers_email_address, a.entry_country_id, a.entry_company, 'Retail' from " . TABLE_CUSTOMERS . " c left join " . TABLE_ADDRESS_BOOK . " a on c.customers_id = a.customers_id and c.customers_default_address_id = a.address_book_id " . $search . " order by $order";
                $info = array();
                $customers = array();
