      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <?php
              echo '<a href="whos_online.php'.(isset($_GET['osCAdminID'])?'?osCAdminID='.$_GET['osCAdminID']:'').'"><b>None</b></a>';
              foreach ($refresh_time as $key => $value) {
                echo ' &#183; <a href="whos_online.php?' . $value . (isset($_GET['osCAdminID'])?'&osCAdminID='.$_GET['osCAdminID']:'').'"><b>' . $refresh_display[$key] . '</b></a>';
              }
            ?>
...
// End -->
            ...
            <a href="whos_online.php<?=(isset($_GET['osCAdminID'])?'?osCAdminID='.$_GET['osCAdminID']:'')?>"><b><?php echo TEXT_NONE_; ?></b></a> &#183; 
            <a href="whos_online.php?showAll<?=(isset($_GET['osCAdminID'])?'&osCAdminID='.$_GET['osCAdminID']:'')?>"><b><?php echo TEXT_ALL; ?></b></a> &#183; 
            <a href="whos_online.php?showBots<?=(isset($_GET['osCAdminID'])?'&osCAdminID='.$_GET['osCAdminID']:'')?>"><b><!-- Bots --><?php echo TEXT_BOTS;?></b></a> &#183; 
            <a href="whos_online.php?showCust<?=(isset($_GET['osCAdminID'])?'&osCAdminID='.$_GET['osCAdminID']:'')?>"><b><!-- Customers --><?php echo TEXT_CUSTOMERS;?></b></a>
            </span>
            </td>
