...
<?php
  ...
  if($action == "insert"){
      ...
      $data_query = str_replace('#tID#,\'\'', $cID . ', NULL', $data_query);
  ...
  $infobox_query = tep_db_query("select box_heading, infobox_id from " . TABLE_INFOBOX_CONFIGURATION . " where template_id = '" .(int)$cID. "'");
