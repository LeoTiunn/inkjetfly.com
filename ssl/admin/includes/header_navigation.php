        ...
        if (tep_admin_check_boxes($item_menu[1]) == true) {
          ...
          <td>
            <div class="nav-item" onmouseover="showMenu(this)" onmouseout="hideMenu(this)" style="padding-top: 4px;">
              <div onclick="window.location.href = $(this).up('.nav-item').down('a').href;" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo $item_menu[2]; ?></div>
