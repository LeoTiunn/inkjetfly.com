<?php
/*
  $Id: paypalwpp_checkoutpayment_paymentmodule.php,v 1.0.0.0 2007/11/13 13:41:11 datazen Exp $
  ...
  <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
    <tr class="infoBoxContents">
      <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
        ...
        if ( $modules_count > 1 || MODULE_PAYMENT_PAYPAL_WPP_DIRECT_ENABLED == 'True' ) {
          ?>
          <tr>
            ...
            <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              ?>
                ...
                <td class="main" align="right">
                  ...
                  } elseif (sizeof($selection) > 1 || $ec_enabled ) {
            ...
            <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              echo '<tr id="defaultSelected" class="moduleRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="selectRowEffect(this, ' . $radio_buttons . ')">' . "\n";    
                ...
                <td class="main" align="right">
                  <?php 
                  if ($radio_buttons > 0 ) {
                    echo tep_draw_radio_field('payment', 'paypal_wpp_ec'); 
                  } else {
                    echo tep_draw_hidden_field('payment', 'paypal_wpp_ec');
                  }
                  ?>
                </td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              ...
              <tr>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" colspan="2"><?php echo MODULE_PAYMENT_PAYPAL_WPP_TEXT_ACCEPTANCE_MARK; ?></td>
              </tr>
            </table></td>
            <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
          </tr>
