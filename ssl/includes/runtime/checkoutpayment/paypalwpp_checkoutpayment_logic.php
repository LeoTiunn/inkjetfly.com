<?php
/*
  $Id: paypalwpp_checkoutpayment_logic.php,v 1.0.0.0 2007/11/13 13:41:11 datazen Exp $
...
if ( defined('MODULE_PAYMENT_PAYPAL_WPP_STATUS') && MODULE_PAYMENT_PAYPAL_WPP_STATUS == 'True' && $_SESSION['skip_shipping'] == '1' ) {
