<?php
/*
  $Id: paypalwpp_espanol_lang.php,v 1.0.0.0 2007/11/13 13:41:11 datazen Exp $
...
if (defined('MODULE_PAYMENT_PAYPAL_WPP_STATUS') && MODULE_PAYMENT_PAYPAL_WPP_STATUS == 'True') {
  ...
  define('TEXT_PAYPAL_MARK_EXPLAIN', '<b>Or Continue With PayPal</b><br>Save time. Check out securely. Pay without sharing your financial information.');
