...
define('CONDITION_AGREEMENT', 'I have read the <a style="color: rgb(51, 51, 255);" href="pages.php?pID=2" target="_blank">conditions of use</a> and I agree to them.');
define('CONDITION_AGREEMENT_WARNING', 'Please read our conditions of use and agree to them. If you do not agree, we cannot deliver to you.');
?>
