...
?>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr valign="top">
            <td colspan="2" style="padding-bottom:0px;"><?php echo tep_image( HTTPS_SERVER.DIR_WS_HTTPS_ADMIN.'../includes/modules/payment/paypal/images/paypal_logo.gif','PayPal'); ?></td>
          </tr>
          <tr valign="top">
            <td class="main">
