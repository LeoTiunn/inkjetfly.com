...
$featured_string1a .= '  <tr>' .
                   ...
                   '    <a href="' . tep_href_link(FILENAME_FEATURED_PRODUCTS, tep_get_all_get_params(array('action','cPath','products_id')) . 'action=buy_now&amp;products_id=' . $featured_products4_array[$i]['id'] . '&cPath=' . tep_get_product_path($featured_products4_array[$i]['id']), 'NONSSL') . '">' . tep_template_image_button('button_buy_now.gif', IMAGE_BUTTON_BUY_NOW) . '</a></td>' .
                   '  </tr>' ;
