...
echo '181' .(file_exists(DIR_FS_EXTENSIONS . 'HTMLPurifier/HTMLPurifier.auto.php')?'yes':'No');
// set up and config HTMLPurfier
/*require_once DIR_FS_EXTENSIONS . 'HTMLPurifier/HTMLPurifier.auto.php';    echo '182';
  ...
  if ($category_depth == 'nested') {
    ...
    if (isset($_GET['manufacturers_id'])) {
      if (isset($_GET['filter_id']) && tep_not_null($_GET['filter_id'])) {
        ...
        if (isset($status_product_prices_table) && $status_product_prices_table == true) {
